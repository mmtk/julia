...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_typename_type->name->names = jl_perm_symsvec(19, "name", "module", "singletonname",
                                                    ...
                                                    "cache_entry_count", "max_methods", "constprop_heuristic", "hiddenptrfields");
    const static uint32_t typename_constfields[1]  = { 0b1000110100001001011 }; // TODO: put back atomicfields and constfields in this list
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_svecset(jl_typename_type->types, 18, jl_voidpointer_type);
